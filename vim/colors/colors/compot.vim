...
hi Directory           guifg=#A09754 guibg=NONE    gui=NONE
...
hi Comment          guifg=#3c403b guibg=NONE    gui=italic
...
hi Function         guifg=NONE    guibg=NONE    gui=bold
...
hi Type             guifg=#718394    guibg=NONE    gui=NONE
...
hi link Type erlangRecord
hi link Operator erlangOperator
...
" Ruby
hi link RubyConstant erlangMacro
hi link RubyBlockParameterList erlangList
hi link rubySharpBang Comment
hi link rubyGlobalVariable rubyInstanceVariable
hi link rubyModule rubyClass
hi link rubyInstanceVariable erlangRecord

hi link Directory erlangStringModifier
hi link LustySelected PMenuSel
hi link CtrlPMatch erlangStringModifier
