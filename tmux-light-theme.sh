...
tmux set -g status-style fg='#666666',bg='default'
tmux set -g pane-border-style fg='#313131'
tmux set -g pane-active-border-style fg='#666666'

# are we zoomed into a pane?
tmux set -g status-left '#[fg=#666666] session: #[fg=#000000]#S @ #(cd #{pane_current_path}; (git rev-parse --abbrev-ref HEAD; and echo "none"))'
tmux set -g status-left-length 150
tmux set -g window-status-current-format "#[fg=#000000]#I: #W#{?window_zoomed_flag, #[fg=#569CD6]󰊓 ,}"
tmux set -g window-status-format "#[fg=#666666]#I: #W#{?window_zoomed_flag, 󰊓 ,}"
...
tmux set -g copy-mode-marBk-style bg='#313244',fg='#fab387'
